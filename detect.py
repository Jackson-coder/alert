...
def detect(opt):
    ...
    detector = Detector("/root/autodl-tmp/lyh/alert/data/video/Seg0.json",k_thr=0.1, mode='unnormal')
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                for det_index in range(len(output)):
                    ...
                    flag = detector.judge3DInvade(kpts, 0.6, im0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/video/40', help='source')  # file/folder, 0 for webcam
