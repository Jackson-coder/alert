...
def detect(opt):
    ...
    detector = Detector("/root/autodl-tmp/lyh/alert/data/video/Seg1.json",k_thr=0.1, mode='unnormal')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='data/video/28', help='source')  # file/folder, 0 for webcam
