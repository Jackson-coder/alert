...
def model_inference_image_list(model_path, img_path=None, mean=None, scale=None, dst_path=None):
    ...
    for img_index, img_file  in pbar:
        ...
        post_process(img_file, dst_file, output[0], mean=mean, scale=scale, score_threshold=0.3)


def post_process(img_file, dst_file, output, mean=None, scale=None, score_threshold=0.3):
    """
